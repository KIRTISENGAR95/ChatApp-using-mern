    ...
    return(
        <div className='w-full h-[100vh] bg-slate-200 flex flex-col items-center justify-center gap-[20px]'>
            ...
            <form className='w-[95%] h-[600px] max-w-[500px] flex flex-col gap-[20px] items-center justify-center'>
                ...
                <input type="text" readOnly className='w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[20px] py-[10px] bg-[white] rounded-lg shadow-gray-200 shadow-lg text-gray-400 text-[19px]' value={userData.userName}></input>
                <input type="email" readOnly className='w-[90%] h-[50px] outline-none border-2 border-[#20c7ff] px-[20px] py-[10px] bg-[white] rounded-lg shadow-gray-200 shadow-lg text-gray-400 text-[19px]' value={userData?.email}></input>
